 ...
 * @create 2018/7/11
 */
@Component("airBookStage21")
public class AirBookStage21 implements AirBookStage {
    ...
    public AirBookRequest buildRequest() {
        ...
        airBookVO.setTicketTimeLimit("2014-09-26T00:01:00");
    ...
    private void fillItinerary(AirBookRequestVO airBookVO) {
        ...
        flightSegmentVO.setDepartureDateTime("2014-09-29T07:30:00");
        flightSegmentVO.setArrivalDateTime("2014-09-29T09:40:00");
