...
public enum IBEError {
    ...
    BUSINESS_ERROR_55001("-55001", "fail to price the refund fee", "计算退票费失败"),
    BUSINESS_ERROR_55011("-55011", "fail to refund the ticket", "退票失败"),
    BUSINESS_ERROR_55012("-55012", "fail to refund the tickets partly", "部分退票失败"),
    BUSINESS_ERROR_55032("-55032", "fail to query the refund form information", "查看退票单信息失败"),
    ...
    BUSINESS_ERROR_60025("-60025", "fail to validate information", "验证信息失败"),
    ...
    BUSINESS_ERROR_60041("-60041", "fail to finish the transactions partly", "操作部分失败"),
    BUSINESS_ERROR_60042("-60042", "fail to finish the transactions", "操作失败"),
    BUSINESS_ERROR_61001("-61001", "fail to book order", "预订生成订单失败"),
    ...
    BUSINESS_ERROR_PLUS_407("407", "the validation of change is fail", "变更校验失败"),
