...
<html lang="en">
	...
	<script type="text/javascript" src="/js/policyhot/industryParticipation.js"></script>
	</head>
	<body>
		...
		<div class="rightBody">
             <div class="rightBody-small">
                ...
                <div class="rightBody-switchover">
                    <h5 id="volumeTrendTitle">政策参与度行业排行
                    <div class="tishi"> 
					    <img src="/images/tishi.png" onmouseenter="tishi(this)" onmouseleave="xiaoshi(this)" 
							    title="参与政策行业报道阅读量前五名排行">
						</div>
                    </h5>
