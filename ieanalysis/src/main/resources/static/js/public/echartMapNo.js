function loadMapNoAjax(echartdata){
	...
	$.ajax({
        ...
        success: function(result) {
        	if(result.data!=null){
        		...
        		loadMapNoEchart(result,document.getElementsByClassName(echartdata.nodeId)[0],echartdata);
        	}else{
...
function loadMapNoEchart(result,dom,echartdata){
	closeloading(dom);
