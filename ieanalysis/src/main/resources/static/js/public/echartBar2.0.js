function loadBarAjax(echartdata){
	...
	$.ajax({
        ...
        success: function(result) {
        	if(result.data!=null){
        		...
        		loadBarEchart(result,document.getElementsByClassName(echartdata.nodeId)[0],echartdata);
        	}else{
...
function loadBarEchart(result,dom,echartdata){
	closeloading(dom);
