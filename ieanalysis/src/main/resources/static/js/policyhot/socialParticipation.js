...
function loadfirst(type){
	...
	echartdata.url="/policyhot/searchPolicyHotSocialEmotionAnalysis.json";
...
function loadsecond(){
	...
	echartdata.url="/policyhot/searchPolicyHotSocialChannelAnalysis.json";
...
function loadthird(){
	...
	echartdata.data=postData();
	echartdata.color=['#79d2f7', '#ff9271','#9fe3ff'];
	echartdata.url="/policyhot/searchPolicyHotSocialChannelDistributeAnalysis.json";
