...
public class NewsLibBakServiceImpl implements NewsLibBakService {
    ...
    public List<NewsLibBak> findOneHundred(NewsLibBak news, Pageable pageable) {
        ...
        Page<NewsLibBak> page = newsLibBakRepository.findAll(new Specification<NewsLibBak>() {
            @Override
            public Predicate toPredicate(Root<NewsLibBak> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
