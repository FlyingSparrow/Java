...
public class RecruitmentBakServiceImpl implements RecruitmentBakService {
    ...
    public List<RecruitmentBak> findOneHundred(RecruitmentBak data, Pageable pageable) {
        ...
        Page<RecruitmentBak> page = recruitmentBakRepository.findAll(new Specification<RecruitmentBak>() {
            @Override
            public Predicate toPredicate(Root<RecruitmentBak> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
