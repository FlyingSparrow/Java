...
public class InvestmentDataBakServiceImpl implements InvestmentDataBakService {
    ...
    public List<InvestmentDataBak> findOneHundred(InvestmentDataBak data, Pageable pageable) {
        ...
        Page<InvestmentDataBak> page = investmentDataBakRepository.findAll(new Specification<InvestmentDataBak>() {
            @Override
            public Predicate toPredicate(Root<InvestmentDataBak> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
