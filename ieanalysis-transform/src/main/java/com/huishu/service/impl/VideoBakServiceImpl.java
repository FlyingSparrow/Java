...
public class VideoBakServiceImpl implements VideoBakService {
    ...
    public List<VideoBak> findOneHundred(VideoBak data, Pageable pageable) {
        ...
        Page<VideoBak> page = videoBakRepository.findAll(new Specification<VideoBak>() {
            @Override
            public Predicate toPredicate(Root<VideoBak> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
