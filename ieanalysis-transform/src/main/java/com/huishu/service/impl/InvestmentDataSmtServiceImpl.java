...
public class InvestmentDataSmtServiceImpl implements InvestmentDataSmtService {
    ...
    public List<InvestmentDataSmt> findOneHundred(InvestmentDataSmt data, Pageable pageable) {
        ...
        Page<InvestmentDataSmt> page = investmentDataSmtRepository.findAll(new Specification<InvestmentDataSmt>() {
            @Override
            public Predicate toPredicate(Root<InvestmentDataSmt> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
