...
public class ZongheBakServiceImpl implements ZongheBakService {
    ...
    public List<ZongheBak> findOneHundred(ZongheBak news, Pageable pageable) {
        ...
        Page<ZongheBak> page = zongheBakRepository.findAll(new Specification<ZongheBak>() {
            @Override
            public Predicate toPredicate(Root<ZongheBak> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
