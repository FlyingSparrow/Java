...
public class MergerDataBakServiceImpl implements MergerDataBakService {
    ...
    public List<MergerDataBak> findOneHundred(MergerDataBak data, Pageable pageable) {
        ...
        Page<MergerDataBak> page = megerDataBakRepository.findAll(new Specification<MergerDataBak>() {
            @Override
            public Predicate toPredicate(Root<MergerDataBak> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
